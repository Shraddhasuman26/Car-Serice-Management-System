...
CREATE TABLE `phone_no` (
  ...
  UNIQUE KEY `idx_phone_no_Client_ID` (`Client_ID`),
  KEY `Client_IDFK_idx` (`Client_ID`),
  CONSTRAINT `Client_IDFK` FOREIGN KEY (`Client_ID`) REFERENCES `client2` (`Client_ID`)
...
INSERT INTO `phone_no` VALUES (101,9348893015),(102,9440549884),(103,7978490400),(104,8249776589),(105,7978893321);
